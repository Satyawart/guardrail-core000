-- Phase 33 QA Fix: Fix column names in process_review_decision (remove hash)
...
BEGIN
    ...
    -- Insert Audit Event
    INSERT INTO audit_events (merchant_id, event_type, actor_type, actor_id, entity_type, entity_id, transaction_id, metadata)
    VALUES (
        v_merchant_id,
        'SUPERVISOR_REVIEW',
        'USER',
